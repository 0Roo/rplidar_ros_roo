...
pc_pub = rospy.Publisher("converted_pc1", PointCloud2, queue_size=1)
pc_pub2 = rospy.Publisher("converted_pc2", PointCloud2, queue_size=1)
...
def scan_cb2(msg):
    pc2_msg = lp.projectLaser(msg)
    pc_pub2.publish(pc2_msg)



rospy.Subscriber("lidar0/scan", LaserScan, scan_cb1, queue_size=1)
rospy.Subscriber("lidar1/scan", LaserScan, scan_cb2, queue_size=1)
